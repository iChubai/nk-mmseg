...
model = dict(
    ...
    backbone='DFormer-Small',
    decoder='ham',
    decoder_embed_dim=512,
    num_classes=num_classes,
    drop_path_rate=0.1,
    aux_rate=0.0,
    pretrained_model='checkpoints/pretrained/DFormer_Small.pth.tar',
    syncbn=True,
)
...
seed = 12345
work_dir = 'work_dirs/dformer/dformer_small_8xb16-300e_sunrgbd-480x480'
